			...
			if (nmapp != null) {
				if (this.output == null) {
					...
					try {
						...
						pw.printf("#!/bin/sh%n");
						pw.printf("# This file is autogenerated.  If you find problems, please edit MXplorAppProcessor.java instead%n");
						pw.printf("%n");
						...
						pw.printf("%n");
						pw.printf("if ! [ -e \"${APP_DIR}/lib/mxplor.jar\" ]; then%n");
						pw.printf("  echo \"Couldn't find mxplor.jar.  Have you compiled mxplor?\"%n");
						pw.printf("  exit 1%n");
						pw.printf("fi%n");
						pw.printf("%n");
